...
### 🔭 Featured Projects
- **[log-analyzer](https://github.com/Romil2112/log-analyzer)** — Python security CLI: brute-force/port-scan detection, Isolation Forest ML anomaly scoring, MITRE ATT&CK mapping, Sigma rule export, and Claude-API incident summaries via a concurrent, cost-instrumented batch layer (~8× throughput). Dockerized, 126 pytest tests in CI.
